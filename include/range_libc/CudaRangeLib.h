...
public:
    ...
    void calc_range_eval_sensor_model_particle(float *x, float *y, float *angle, float *obs, float * angles, double *weights, int num_particles, int num_angles);
...
private:
    ...
    float *d_px, *d_py, *d_pangle;
    float *d_angles, *d_obs;
    int particles_allocated;
